...
import com.electro.biology.bacteria.machines.Recpies.HarvesterRecipes;
...
public class TileEntityharvester extends TileEntityMachine implements IInventory {
    ...
    public void updateEntity() {
        ...
        ItemStack result = HarvesterRecipes.id().getResult(input, new Random());
    ...
    public TileEntityharvester(int invSize) {
        super();
