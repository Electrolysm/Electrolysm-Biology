...
public class GUIHarvester extends GuiContainer {
	...
	public TileEntityharvester entity;
	public GUIHarvester(TileEntityharvester te, InventoryPlayer inv) {
		super(new ContainerHarvester(te, inv));
		entity = te;
	}

	private ResourceLocation GuiTexture=new ResourceLocation(Reference.MODID,"textures/gui/harvesterGUI.png");
	@Override
